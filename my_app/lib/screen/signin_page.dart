...
import 'package:cmsc23proj/screen/home_page.dart';
        ...
        if (result == "donor") {
          showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                ...
                content: const Text('You have successfully logged in as a donor.', style: TextStyle(color: Colors.black)),
                actions: <Widget>[
                  TextButton(
                    onPressed: () {
          ...
          showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                title: const Text('Login Successful', style: TextStyle(color: Colors.black)),
                content: const Text('You have successfully logged in as an organization.', style: TextStyle(color: Colors.black)),
                actions: <Widget>[
                  TextButton(
                    onPressed: () {
                      Navigator.of(context).pop();
          ...
          showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                title: const Text('Login Successful', style: TextStyle(color: Colors.black)),
                content: const Text('You have successfully logged in as an administrator.', style: TextStyle(color: Colors.black)),
                actions: <Widget>[
                  TextButton(
                    onPressed: () {
                      Navigator.of(context).pop();
        ...
        if (user != null) {
          ...
          showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                title: const Text('Login Successful', style: TextStyle(color: Colors.black)),
                content: const Text('You have successfully logged in as a donor using google.', style: TextStyle(color: Colors.black)),
                actions: <Widget>[
                  TextButton(
                    onPressed: () {
                      Navigator.of(context).pop();
