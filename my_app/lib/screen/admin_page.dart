  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          title: Text(data['organizationName'], style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
...
class DonationTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String modeOfDelivery = data['For Delivery?'] ? 'Drop-off' : 'Pickup';
    ...
    return Card(
      ...
      child: Theme(
        data: Theme.of(context).copyWith(dividerColor: Colors.transparent), // Set divider color to transparent
        child: ExpansionTile(
          title: Text(data['Email'], style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
          ...
          children: [
            ...
            ListTile(
              title: Text('Mode of Delivery: $modeOfDelivery'),
            ),
            _buildDeliveryDetails(modeOfDelivery, data), // Render delivery details based on mode
          ],
        ),
      ),
    );
  ...
  Widget _buildDeliveryDetails(String modeOfDelivery, Map<String, dynamic> data) {
    if (modeOfDelivery == 'Drop-off') {
      return ListTile(
        title: Text('Drop-off Date: ${data['Date']}'),
      );
      ...
      return Column(
        ...
        children: [
          ListTile(
            title: Text('Contact Number: ${data['Contact Number']}'),
          ),
          ListTile(
            title: Text('Address: ${data['Address']}'),
          ),
